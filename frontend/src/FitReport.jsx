...
import { PRIORITY_HELP, PriorityBadge } from './Priority.jsx'
...
/** The Fit report tab: summary first, then the evidence behind it. */
export default function FitReport({ result }) {
